  ...
  return (
    <main className="mx-auto max-w-7xl px-6 pb-20 pt-4">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <aside className="space-y-6 lg:col-span-3">
          <div className="rounded-xl border bg-white p-4">
            <h4 className="mb-2 font-semibold">Publicar en Nova</h4>
            <p className="mb-3 text-sm text-slate-600">Publica artículos verificados y gana reputación con tu perfil científico.</p>
            <Link
              href={user ? '/editor' : '/auth/signin'}
              className="inline-flex rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800"
            >
              {authLoading ? 'Verificando sesión...' : user ? 'Ir al editor' : 'Iniciar sesión para publicar'}
            </Link>
          </div>
